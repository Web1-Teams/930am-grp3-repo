  ...
  return (
    <div className="adopt-info-section-between66">
      ...
      <p className="adopt-info-paragraph-between66">
        ...
        also showcasing animals directly under Rafeeq’s care.
        <br />
        Each adoption involves a small fee, which helps cover care and medical
        expenses.
        <br />
        Fees vary based on the type of animal and their age, ensuring a fair
        process for all adopters.
        <br />
      </p>
    </div>
  );
...
export default SecondAdoptionInfoContainer;
